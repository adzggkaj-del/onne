...
export const mockCoins: CoinData[] = [
  {
    ...
    icon: "₿", chain: "ethereum", priceUsd: 96842, priceKrw: 96842 * KRW_RATE * PRICE_MARKUP,
  ...
  },
  {
    ...
    icon: "⬡", chain: "polygon", priceUsd: 0.92, priceKrw: 0.92 * KRW_RATE * PRICE_MARKUP,
    change24h: 3.45, volume24h: 650000000, sparkline: generateSparkline(0.92, 0.02),
  },
  {
    id: "usdt", symbol: "USDT", name: "Tether", nameKr: "테더",
    icon: "₮", chain: "ethereum", priceUsd: 1.0, priceKrw: 1.0 * KRW_RATE * PRICE_MARKUP,
